...
[`../docs/ops/spec.md`](../docs/ops/spec.md)** — `scripts/` is part of the ops surface, and that page
also says why the tool configurations sit here rather than at the repository root.
