...
| `scripts/tests/`                  | any           | pytest over the checkers: the documentation gate, the exit contract, the message gates, the kernel's floors and the compose mirror's port guard |
