...
| `scripts/tests/`                           | any           | pytest over the gate and the checkers this folder holds — one module per subject, named for it, so the directory answers what is covered |
