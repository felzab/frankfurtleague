...
| `scripts/tests/`                    | any           | pytest over the documentation gate and its copy corpus, the branch checks, the kernel's floors, the compose mirror, conflict markers and the unit pool's exit statuses |
