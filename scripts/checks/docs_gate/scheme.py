...
PAIRS: Final[tuple[Pair, ...]] = (
    ...
    Pair("FilterPanel picked row", Layer("--fg-base"), Layer("--bg-picked"), 4.5),
    Pair("FilterPanel picked row, hovered", Layer("--fg-base"), Layer("--bg-picked-hover"), 4.5),
    Pair("FilterPanel picked row, check", Layer("--accent-brand"), Layer("--bg-picked"), 3.0),
    Pair("FilterPanel picked row, check, hovered", Layer("--accent-brand"), Layer("--bg-picked-hover"), 3.0),
...
HOVERS: Final[tuple[Hover, ...]] = (
    ...
    Hover("--bg-picked-hover", "--bg-picked", -1, 1),
