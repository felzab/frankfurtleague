...
PAIRS: Final[tuple[Pair, ...]] = (
    ...
    Pair("popover badge", Layer("--accent-success-strong"), Layer("--accent-success", 10, "--bg-surface"), 4.5),
    Pair("dot, timer bar", Layer("--accent-success"), Layer("--bg-surface"), 3.0),
    Pair("", Layer("--fg-on-success"), Layer("--accent-success-solid"), 4.5),
    ...
    Pair("popover badge", Layer("--accent-warn-strong"), Layer("--accent-warn", 10, "--bg-surface"), 4.5),
    Pair("dot, timer bar", Layer("--accent-warn"), Layer("--bg-surface"), 3.0),
    Pair("", Layer("--fg-on-warn"), Layer("--accent-warn-solid"), 4.5),
    ...
    Pair("popover badge", Layer("--accent-danger-strong"), Layer("--accent-danger", 10, "--bg-surface"), 4.5),
    Pair("dot, timer bar", Layer("--accent-danger"), Layer("--bg-surface"), 3.0),
    Pair("", Layer("--fg-on-danger"), Layer("--accent-danger-solid"), 4.5),
