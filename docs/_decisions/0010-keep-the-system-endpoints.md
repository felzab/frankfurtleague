# ADR-0010 — Keep the unused system endpoints and their API key
...
was added (a decision since retired; [ADR-0028](0028-reference-data-staleness-is-bounded-by-cache-lifetime.md)
