# ADR-0012 — `admin` is an aggregator slice, and cross-feature lints must be scoped
...
**Supersedes:** —
**Superseded by:** —
**Source:** Rule A7 of the ratified-rules register CLAUDE.md carried, extracted into this folder 2026-07-29
...
`useAdmin()` — see [ADR-0005](0005-spiel-write-path-belongs-to-spiele.md).
...
write path did move out under [ADR-0005](0005-spiel-write-path-belongs-to-spiele.md). What cannot move
