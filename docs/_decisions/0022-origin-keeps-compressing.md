...
**Supersedes:** —
**Superseded by:** —
**Source:** A PageSpeed remediation change (retired number 0021) was deployed, then measured against
...
On that reading, a change (retired as 0021) stopped the origin compressing `/_next/static/` —
...
attacked at the source instead ([ADR-0023](0023-admin-only-css-split.md)).
