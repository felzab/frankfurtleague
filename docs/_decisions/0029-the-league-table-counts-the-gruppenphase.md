# ADR-0029 — The league table counts the Gruppenphase, and that is what an omitted scope means
...
**The statistics are derived, not stored** ([ADR-0026](0026-team-statistics-are-derived-from-spiele.md),
...
shape ADR-0026 removed from the database.
