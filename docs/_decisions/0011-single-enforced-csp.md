# ADR-0011 — One enforced CSP keeping `unsafe-inline`, with `react/no-danger` as the compensating control
...
**Supersedes:** —\
**Superseded by:** —\
**Source:** The security pass of the frontend audit and remediation programme, whose posture ruling
of 2026-07-30 stands in its permanent record, `docs/_auditing/reports/2026-07-frontend.md`.
