# ADR-0012 — Publish to GitHub Container Registry as two public packages
...
The single definition of the registry and repository names is `scripts/_lib.sh`; the retention
policy, the publish and deploy contract, the services contract and its invariants are
[`docs/ops/spec.md`](../ops/spec.md)'s; what the repository cannot record about the deployment host
is [`docs/ops/runbooks.md`](../ops/runbooks.md)'s.
