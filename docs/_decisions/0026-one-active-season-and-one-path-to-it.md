...
[ADR-0020](0020-the-database-enforces-its-own-invariants.md) gave every collection a `$jsonSchema`
...
[ADR-0025](0025-soft-deletion-is-a-date-not-a-flag.md). No row there is ever retired, so
