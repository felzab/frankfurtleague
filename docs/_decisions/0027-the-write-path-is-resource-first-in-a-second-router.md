# ADR-0027 — The write path is resource-first, in a second router per slice
...
seven slices' schemas and services, is the aggregator shape that ADR-0008 permits for `admin` on the
