# ADR-0013 — Import HeroUI's CSS per component, not as one entry point
...
trusted: the checklist lives in [`docs/frontend/spec.md`](../frontend/spec.md#111-adding-a-heroui-component),
...
[`docs/frontend/spec.md`](../frontend/spec.md#111-adding-a-heroui-component), and the
