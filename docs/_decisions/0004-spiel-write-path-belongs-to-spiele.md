# ADR-0004 — The Spiel write path belongs to `spiele`, not `admin`
...
**Supersedes:** —\
**Superseded by:** —\
**Source:** A finding of the frontend audit and remediation programme, 2026-07-31, amending the
slice-ownership rule [ADR-0008](0008-admin-is-an-aggregator-slice.md) carries; the programme's
...
[ADR-0008](0008-admin-is-an-aggregator-slice.md).
...
([ADR-0009](0009-admin-scoped-reads-are-never-cached.md)).
