# ADR-0006 — `await connection()` guards every page data fetch
...
**Supersedes:** —\
**Superseded by:** —\
**Source:** Ratified 2026-07-29 by the frontend audit and remediation programme and reworded
2026-07-31; the programme's permanent record is `docs/_auditing/reports/2026-07-frontend.md`.
