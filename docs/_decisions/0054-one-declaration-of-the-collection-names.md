# ADR-0054 — One declaration of the collection names, as a `StrEnum`
...
**Supersedes:** —\
**Superseded by:** —\
**Source:** Fallout from [ADR-0053](0053-the-domain-model-is-declared-and-conformance-checked.md). Its
...
**`fl_backend/app/core/collections.py :: Collection` is the one declaration, and every one of those
five reads it.**
...
[ADR-0024](0024-the-third-copy-of-the-schema-is-checked-not-generated.md) exists to avoid. Motor's API takes
...
every schema and the drift ADR-0024 measured.
