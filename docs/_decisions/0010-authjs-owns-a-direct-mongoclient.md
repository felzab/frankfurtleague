# ADR-0010 — Auth.js owns a direct `MongoClient`; nothing else in the frontend does
...
**Supersedes:** —
**Superseded by:** —
**Source:** Rule A2 of the ratified-rules register CLAUDE.md carried, extracted into this folder 2026-07-29
