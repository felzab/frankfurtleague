...
Twenty-one decisions. The first sixteen were extracted 2026-08-01 from material that already existed in argued form — CLAUDE.md §9
...
| [0021](0021-static-assets-reach-the-edge-uncompressed.md) | Static assets reach the edge uncompressed                    | ops, frontend          | Accepted | 2026-08-01 |

`Surface` lists every surface a decision touches. A decision spanning two is normal and is the reason
this folder is flat.

**By surface** — backend: 0001 · 0002 · 0014 · ops: 0009 · 0011 · 0014 · 0015 · 0016 · 0017 · 0021 · frontend: all
except 0017.
