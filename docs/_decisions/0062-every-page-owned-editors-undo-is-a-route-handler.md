...
2026-08-06, when the match editor's undo first failed (retired numbers 0055 and 0060 recorded the
...
([ADR-0051](0051-a-voided-result-is-named-before-it-is-lost.md)), so by the time it is pressed the
...
holds — a lifted disqualification's reason and date have no other copy anywhere (ADR-0059, and the
...
([ADR-0050](0050-a-form-that-outgrows-a-dialog-becomes-a-page.md)), and nothing else becomes a
...
**The editors get no confirmation dialog**, for ADR-0051's reason: undo and confirmation are
...
pages that deliberately have no confirmation dialog (ADR-0051), so losing it removes the mechanism
