...
The three cheapest come first on purpose: each is an afternoon, and each makes everything written
after it correct by default rather than needing a second pass. F7 leads on its clock — left alone it
