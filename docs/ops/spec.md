...
| OPS-89 | A refusal mapper outside a slice's `actions.ts` is unswept            | Open — `fl_frontend/src/core/refusalPaths.test.ts` filters the half that reads hand-written `fieldErrors` literals to `features/*/actions.ts`, so a mapper living in a slice module beside them is read by nothing and the sweep that holds [`docs/frontend/spec.md`](../frontend/spec.md) I34 is narrower than it appears. Tracked in [`docs/_roadmap/tooling-items.md`](../_roadmap/tooling-items.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
