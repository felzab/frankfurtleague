...
`= /signin` and `= /api/client-error` each carry one; this location does not, and it inherits the server
...
| OPS-88 | The gate's corpus is the git index                                    | Open — `scripts/docs_gate/kernel.py :: tracked_files` enumerates through `git ls-files` with no `--others`, so a file the branch has written but not staged is in no check's reach, and the run that clears a branch before its commit reads less than CI's does over the committed tree. Tracked in [`docs/_roadmap/tooling-items.md`](../_roadmap/tooling-items.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
