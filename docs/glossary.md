...
**See:** [ADR-0052](_decisions/0052-a-seasons-schedule-is-derived-from-its-rules.md) for what `rules` derives, [ADR-0026](_decisions/0026-one-active-season-and-one-path-to-it.md) for the single path to `status`.
...
**See:** backend spec I32 for the joined field, [ADR-0037](_decisions/0037-a-seasons-fixtures-are-created-once.md) for the two absences.
...
**See:** [ADR-0051](_decisions/0051-a-matchdays-position-is-derived-not-stored.md), and [ADR-0052](_decisions/0052-a-seasons-schedule-is-derived-from-its-rules.md) for the count.
...
**See:** [ADR-0048](_decisions/0048-position-and-stufe-are-closed-sets.md) for the two closed sets.
...
**See:** [ADR-0021](_decisions/0021-store-what-was-true-then-derive-what-is-true-now.md) for which embedded copies are maintained.
...
**See:** [ADR-0021](_decisions/0021-store-what-was-true-then-derive-what-is-true-now.md).
...
**See:** [ADR-0036](_decisions/0036-a-shoot-out-is-its-own-scoreline.md) for why a shoot-out is never in this string.
...
**See:** [ADR-0036](_decisions/0036-a-shoot-out-is-its-own-scoreline.md), backend spec I25 and I25a.
...
**See:** [ADR-0035](_decisions/0035-a-group-placing-is-ranked-by-one-chain-and-seeded-only-when-final.md), backend spec I10.
...
**See:** [ADR-0052](_decisions/0052-a-seasons-schedule-is-derived-from-its-rules.md), [ADR-0022](_decisions/0022-the-league-table-counts-the-gruppenphase.md).
...
**See:** [ADR-0058](_decisions/0058-a-status-filter-is-not-a-status-label.md).
...
**See:** [ADR-0034](_decisions/0034-a-result-entry-resolves-the-whole-bracket.md), backend spec I22 for the independence and I28 for the faults a resolution reports.
...
**See:** [ADR-0035](_decisions/0035-a-group-placing-is-ranked-by-one-chain-and-seeded-only-when-final.md), backend spec I24b.
...
**See:** [ADR-0034](_decisions/0034-a-result-entry-resolves-the-whole-bracket.md).
...
**See:** [ADR-0047](_decisions/0047-a-disqualification-is-a-record-and-its-absence-is-the-null.md), backend spec I31.
...
**See:** [ADR-0025](_decisions/0025-soft-deletion-is-a-date-not-a-flag.md) for the junction's write path.
...
**See:** [ADR-0025](_decisions/0025-soft-deletion-is-a-date-not-a-flag.md), backend spec I20.
