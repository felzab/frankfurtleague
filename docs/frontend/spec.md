...
| I359 | **While no season is `active`, every admin page passing an omitted season to a backend read sends the admin to `/admin/saisons`**                                                                                                          | `fl_frontend/src/app/admin/(current-saison)/layout.tsx`, reading the running season and never the list; `fl_frontend/src/app/admin/currentSaison.test.ts`; `fl_frontend/src/app/admin/omittedSaison.test.ts` sweeps every page outside it                                                                                                                                                                                                                                               |
