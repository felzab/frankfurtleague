...
| I402 | **The address field's passkey offer is armed only where the browser supports it, and again only after a ceremony the reader started**: otherwise a refusal repeats without end                                                                     | `fl_frontend/src/features/auth/components/forms/PasskeySignIn.tsx :: PasskeySignIn`; `fl_frontend/src/features/auth/components/forms/PasskeySignIn.test.ts`                                                                                                                                                                                                                                                                                                                         |
