...
| I359 | **Every admin page reads the season the header's selector shows**: the address's, else the running one, else the list's first, **never an omitted one**                                                                                    | `fl_frontend/src/features/saisons/resolvers.ts :: resolveAdminSaison`; `fl_frontend/src/app/admin/omittedSaison.test.ts` renders every page in each league the selector resolves                                                                                                                                                                                                                                                                                                        |
