...
| I148 | **Every confirmation page's stored wording label is the registry's, stamped by the route handler**: a label the browser sends is read and dropped                                                                                          | `fl_frontend/src/features/bewerbungen/utils.ts :: stampEinwilligungFassung`, called by all three confirmation handlers; `fl_frontend/src/features/bewerbungen/utils.test.ts :: replaces whatever label the request carried with the registry's own`                                                                                                                                                                                                      |
