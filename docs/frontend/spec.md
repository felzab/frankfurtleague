...
| I381 | **The forbidden panel names nothing of the address it refuses** and links only to seats held elsewhere, or to `/bereich` where none is                                                                                                             | `fl_frontend/src/features/funktionen/components/ui/TeamForbiddenPanel.tsx`; `fl_frontend/src/features/funktionen/team.test.ts`                                                                                                                                                                                                                                                                                                                                                      |
