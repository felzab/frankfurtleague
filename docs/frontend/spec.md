...
| I80  | **One shared component renders every panel heading**, which is what makes the heading level a single decision                                                                                                                              | `fl_frontend/src/shared/components/ui/PanelHeading.test.ts`, which fails a heading taking `heading()` outside the component; a bare `<h2>` carries no marker parting it from any other                                                                                                                                                                                                                                                                                                  |
