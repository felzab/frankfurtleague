...
| I368 | **A field is marked required exactly where its form's schema refuses its emptied value**                                                                                                                                                   | `fl_frontend/src/shared/components/ui/RequiredMarks.tsx :: requiredBy`, pinned by `fl_frontend/src/shared/components/ui/requiredMarking.test.ts`; `fl_frontend/eslint.config.mjs :: HEROUI_MARKED_FIELDS` and its literal `isRequired` ban                                                                                                                                                                                                                                          |
