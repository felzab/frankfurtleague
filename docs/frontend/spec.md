...
| I362 | **Every sign-in store operation of a connected client ends within its `timeoutMS`**, commits included: the driver's first connect answers only to `serverSelectionTimeoutMS`                                                               | `fl_frontend/src/core/db.ts :: options`; `fl_frontend/src/core/db.db.test.ts` hangs a session read and a commit, holding the experimental option across driver upgrades                                                                                                                                                                                                                                                                                                                 |
