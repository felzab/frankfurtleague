...
| I312 | **A removal takes a fresh assertion and never the last row**: a cookie alone could otherwise swap the administrator's authenticator for its own                                                                                            | `fl_frontend/src/features/passkeys/actions.ts :: removePasskeyAction`, over `fl_frontend/src/core/auth.ts :: isRecentlyAsserted`; `fl_frontend/src/features/passkeys/actions.test.ts :: "what a removal costs, and what it refuses"`                                                                                                                                                                                                                     |
| I313 | **Removing a passkey ends that administrator's other sessions**: the sessions the removed authenticator made outlive the row itself                                                                                                        | `fl_frontend/src/features/passkeys/actions.ts :: removePasskeyAction`, whose case drives a second session's cookie against `fl_frontend/src/core/auth.ts :: getAdminSession` after the removal                                                                                                                                                                                                                                                           |
