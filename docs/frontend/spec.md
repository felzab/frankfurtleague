...
| I385 | **A read failing in an area layout is answered by that area's own panel inside its shell**; a redirect or a not-found passes through to Next                                                                                                       | `fl_frontend/src/app/bereich/layoutErrors.test.ts`, over `PersonAreaBoundary`, `TeamAreaBoundary` and `AdminAreaBoundary`                                                                                                                                                                                                                                                                                                                                                           |
