...
| `no-restricted-syntax`: `fl_frontend/src/shared/utils/publicSubmit.ts` imported or loaded without the `"use client"` prologue                                                | Only the browser's panels read the submit helper; a sentence a route shares with them lives in `fl_frontend/src/shared/utils/reopenLink.ts`                                                                                                                                                |
