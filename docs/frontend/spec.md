...
| I234 | **Every `gap-*` is one of `0.5 1 2 3 4 6 8 12`, `gap-0` aside, and a responsive pair is two adjacent rungs**                                                                                                                               | `fl_frontend/src/shared/components/ui/gapLadder.test.ts`, which declares the rungs and reads every string literal, recipe modules included; an interpolated value tokenises to `gap-` and is dropped                                                                                                                                                                                                                                                                                    |
