...
| I148 | **Only the wording label the running build renders is stored**: every confirmation, application seat and admin reseat is refused any other before the parse                                                                                | `fl_frontend/src/features/bewerbungen/utils.ts :: nenntLaufendeFassung` and `:: bewerbungNenntLaufendeFassung`; `fl_frontend/src/app/api/bestaetigung/kontakt/route.test.ts`, `fl_frontend/src/app/api/bewerbung/route.test.ts`, `fl_frontend/src/features/bewerbungen/kontaktSitz.test.ts`                                                                                                                                                                                             |
