...
| `funktionen`      |    —    |     —     |    —    |    —    | The person and team areas' guard, shells and landings, and the team's forbidden panel; what a Funktion is, `fl_frontend/src/core/funktionen.ts` answers |
| `dashboard`       |    —    |     —     |    —    |    —    | —                                                                                                                                                       |
| `meta`            |    —    |     —     |    —    |    —    | —                                                                                                                                                       |
...
| I395 | **Every signed-in shell heads its sidemenu with the Funktion switcher**, shown only where the person's Funktionen lead to two or more places                                                                                                       | `fl_frontend/src/shared/components/layout/shell/AppShell.tsx :: funktionSwitcher`; `fl_frontend/src/features/funktionen/switcher.test.ts`; `fl_frontend/src/shared/components/layout/sidemenu/FunktionSwitcher.test.ts :: "when the switcher shows"`                                                                                                                                                                                                                                |
| I396 | **The switcher lists the landing's places under the landing's labels**, and marks the one the address stands in                                                                                                                                    | `fl_frontend/src/features/funktionen/utils.ts :: funktionOrteOf`; `fl_frontend/src/shared/components/layout/sidemenu/FunktionSwitcher.test.ts :: "what the switcher lists"`                                                                                                                                                                                                                                                                                                         |
