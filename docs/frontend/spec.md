...
| I359 | **While no season is `active`, every admin page whose reads default to the running one sends the admin to `/admin/saisons`**                                                                                                               | `fl_frontend/src/app/admin/(current-saison)/layout.tsx`, reading the running season and never the list; `fl_frontend/src/app/admin/currentSaison.test.ts`                                                                                                                                                                                                                                                                                                                               |
