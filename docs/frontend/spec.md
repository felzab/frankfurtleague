...
that inset. A padding is an inset where the child draws a border or a fill; on a child drawing
...
| I234 | **Every `gap-*` is one of `0.5 1 2 3 4 6 8 12`, `gap-0` aside, and a responsive pair is two adjacent rungs**                                                                                                                               | `fl_frontend/src/shared/components/ui/gapLadder.test.ts`, which reads every class list the tree writes and every gapped box's children; the rungs are declared there once                                                                                                                                                |
