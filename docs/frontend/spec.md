...
| I173 | **Every tab stop shows focus**: where the border-based indicator is suppressed, an outline replaces it (WCAG 2.4.7)                                                                                                                        | Review — `fl_frontend/src/app/globals.css` carries the outline fallback for every suppressed border                                                                                                                                                                                             |
