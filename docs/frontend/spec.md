...
| ---------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| An admin write saves and toasts, and the list keeps the old rows until a manual reload                                             | The action moves no tag and calls no `refresh()`, so its response carries no re-rendered payload at all                                                                                 | I233 — every admin write ends its success path with `refresh()`; a tag is for the server cache and never for the page on screen                                          |
