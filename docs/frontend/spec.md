...
| I66  | **One reveal and one action row per panel, whatever it offers**: a second reveal would arm one operation while the row below confirmed the other                                                                                           | `fl_frontend/src/shared/hooks/useTwoPressConfirm.ts`, which holds one armed flag per panel; review                                                                                                                                                                                                                                                                                                                                                                                  |
