...
| I364 | **A sign-in store unreachable at its first connect is connected again once it answers**, never by a restart or a second client                                                                                                             | `fl_frontend/src/core/db.ts :: reconnectingAfterAFailedConnect`; `fl_frontend/src/core/db.db.test.ts` reads again after a refused first connect, and reopens after a hung one                                                                                                                                                                                                                                                                                                           |
