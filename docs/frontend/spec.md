...
| I37  | **A press confirmed in place escalates through the shared two-press control, and a panel spelling its own armed state is the violation**                                                                                                   | `fl_frontend/src/shared/hooks/useTwoPressConfirm.ts`; `fl_frontend/src/shared/components/ui/confirmPanel.test.ts`, whose two rosters walk `features/` alone; review for a panel under `shared/`                                                                                                                                                                                                                                                                                         |
