...
| Pydantic and Zod models are hand-mirrored                                                                                                            | Accepted — checked rather than generated (I17): `fl_frontend/src/core/apiContract.test.ts` compares no pattern, length or message, and `fl_backend/tests/shared/test_frontend_mirrors.py` pairs all three or records why not |
