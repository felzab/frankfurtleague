...
| I380 | **A team's address opens only on a seat held on that team in that season**: any other, a `past` season's included, answers the forbidden panel                                                                                                     | `fl_frontend/src/features/funktionen/resolvers.ts :: requireTeamSeats` in every team page, and `fl_frontend/src/app/bereich/team/[team_id]/[saison_id]/layout.tsx :: TeamChrome`; `fl_frontend/src/features/funktionen/team.test.ts`                                                                                                                                                                                                                                                |
