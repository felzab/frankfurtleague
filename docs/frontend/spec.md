...
| I385 | **A read failing in an area layout is answered by that area's own panel inside its shell**; a redirect or not-found still reaches Next                                                                                                             | `fl_frontend/src/app/bereich/layoutErrors.test.ts`, over `PersonAreaBoundary`, `TeamAreaBoundary` and `AdminAreaBoundary`                                                                                                                                                                                                                                                                                                                                                           |
