...
| I148 | **Only the running build's label is newly stored**: a confirmation, application seat, admin reseat or new contacts seat naming another is refused                                                                                          | `fl_frontend/src/features/bewerbungen/utils.ts :: nenntLaufendeFassung` and `:: bewerbungNenntLaufendeFassung`; `fl_frontend/src/app/api/bestaetigung/kontakt/route.test.ts`, `fl_frontend/src/app/api/bewerbung/route.test.ts`, `fl_frontend/src/features/bewerbungen/kontaktSitz.test.ts`, `fl_frontend/src/features/kontakte/kontakteFassung.test.ts`                                                                                                                                |
