...
| I382 | **Every seat reaches every team-area entry**: `teamStructureFor` selects `TEAM_SIDEMENU_ENTRIES` whole, one row per existing page and no seat rule                                                                                                 | `fl_frontend/src/features/funktionen/constants.ts :: teamStructureFor`; `fl_frontend/src/features/funktionen/structure.test.ts`                                                                                                                                                                                                                                                                                                                                                     |
