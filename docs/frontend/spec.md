...
on a ban the config states that no plant marks.
...
| I13  | Before deleting a `"use client"` directive, check for render props                                                                                                                                                                         | `fl_frontend/eslint.config.mjs :: SCOPED_BANS` and `:: SOURCE_BANS` for the facets shape; review for every other render prop (§4)                                                                                                                                                                                                                                                                                                                                                       |
...
| The render-prop rule I13 states is checked for the facets shape alone, and reviewed elsewhere                                                        | Accepted — `fl_frontend/eslint.config.mjs :: SCOPED_BANS` covers `fl_frontend/src/app/`, `:: SOURCE_BANS` the admin views; a server-render harness is refused                               |
