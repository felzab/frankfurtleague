...
| I238 | **A control outside prose takes its brand grade from one recipe, without the underline that names a link**: a re-spelled grade loses its dark arm                                                                                          | `fl_frontend/src/shared/components/ui/brandInk.ts :: BRAND_INK`; `fl_frontend/src/shared/components/ui/brandInk.test.ts` sweeps every `.tsx` under `src` for a hand-spelled `hover:text-brand-solid`                                                                                                                     |
