...
| I377 | **Every person-area page renders under `FunktionenGuard`, its lane's only session check, and an administrator's render reads no subject**                                                                                                          | `fl_frontend/src/features/funktionen/guard.test.ts :: "the guard over the person area"` and `:: "the subject read an administrator's render makes"`                                                                                                                                                                                                                                                                                                                                 |
