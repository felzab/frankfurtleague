...
| I13  | Before deleting a `"use client"` directive, check for render props                                                                                                                                                                         | `fl_frontend/src/shared/utils/facets.test.ts :: isClientModule` and `:: VIEWS_GLOB` for the facets shape; review for every other render prop (§4)                                                                                                                                                                                                                                                                                                                                       |
