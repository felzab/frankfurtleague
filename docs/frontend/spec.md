...
| I311 | **An account holds at most five passkeys**: nothing else bounds a session that may enrol, and a planted row hides among real ones                                                                                                                  | `fl_frontend/src/core/auth.ts :: PASSKEY_LIMIT`, judged in `:: refuseEnrolment` and again in `fl_frontend/src/features/passkeys/actions.ts :: readPasskeysAction`, which closes the control                                                                                                                                                                                                                                                                                         |
