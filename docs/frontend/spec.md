...
| I363 | **A page whose reads need a season sends a league holding none to `/admin/saisons`**, the page that creates one, rather than to its error page                                                                                             | `fl_frontend/src/features/saisons/resolvers.ts :: requireAdminSaison`; `fl_frontend/src/app/admin/omittedSaison.test.ts`'s empty league                                                                                                                                                                                                                                                                                                                                                 |
