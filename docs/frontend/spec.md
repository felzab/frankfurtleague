...
| I148 | **A confirmation is stored only under the wording label the running build renders**: its route handler refuses any other before the parse                                                                                                  | `fl_frontend/src/features/bewerbungen/utils.ts :: nenntLaufendeFassung`, called by all three confirmation handlers; `fl_frontend/src/app/api/bestaetigung/kontakt/route.test.ts :: refuses a label other than the one this server renders, before the endpoint`                                                                                                                                                                                                                         |
