...
| I362 | **Every sign-in store operation ends within its `timeoutMS`, commits included, and a cold start's automatic connect within `serverSelectionTimeoutMS`**                                                                                    | `fl_frontend/src/core/db.ts :: options`; `fl_frontend/src/core/db.db.test.ts` hangs a cold start, a session read and a commit, holding the experimental option across upgrades; counterpart `docs/backend/spec.md :: I320`                                                                                                                                                                                                                                                              |
