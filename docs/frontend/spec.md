...
| I242 | **A matched 404 streams a 200 and an unmatched one answers 404**, so the root-mounted area takes no catch-all                                                                                                                              | `fl_frontend/src/app/notFound.test.ts` for the absence; unenforced for the status, which only a request against a built stack reads                                                                                                                                                                                      |
