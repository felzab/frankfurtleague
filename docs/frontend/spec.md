...
| I377 | **Every person and team page reads its subject through `requireSubjectSession`, which sends a lapsed session to sign in; a `/bereich/admin` render reads no subject**                                                                              | `fl_frontend/src/features/funktionen/guard.test.ts :: "every person page's subject"` and `:: "an admin render's subject reads"`; `fl_frontend/src/features/funktionen/team.test.ts :: "the guard over a team's area"`                                                                                                                                                                                                                                                               |
