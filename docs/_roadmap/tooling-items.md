...
| 31  | OPS-65  | An unused parameter is reported by no checker here                 | FE, Ops           | S      | Open     | —          |
...
### 31 · OPS-65 — An unused parameter is reported by neither checker the frontend runs
