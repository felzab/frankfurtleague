...
### 37 · OPS-12 — Nothing checks a generated file against the generator that owns it
...
### 38 · DOC-14 — A file that arrives as a rename brings its comment blocks in as context, so INC-9 measures none of them
