...
| 34  | DOC-9   | Pairs of audit checks hunt the same ground                         | Docs              | S      | Open     | —          |
| 35  | DOC-2   | An enforcement claim is resolved in one direction only             | Docs              | M      | Open     | —          |
| 36  | OPS-19  | Both repository-wide linters re-read every file                    | FE, Ops           | S      | Open     | —          |
| 37  | OPS-10  | The comment-only classifier costs a process per file               | Ops               | S      | Open     | —          |
| 38  | OPS-2   | Nothing validates the contents of a restored `.env`                | Ops               | —      | Standing | —          |
| 39  | OPS-3   | Crawler policy split between robots.txt and Cloudflare             | Ops               | —      | Standing | —          |
| 40  | DOC-3   | A rule pattern reaches less than the rule it enforces              | Docs              | —      | Standing | —          |
| 41  | DOC-10  | A block already over a bound is excused by its opening line        | Ops, Docs         | S      | Standing | —          |
...
### 34 · DOC-9 — Pairs of audit checks hunt one another's ground, and only one pair has a boundary about it
...
### 35 · DOC-2 — An enforcement claim is resolved in one direction only
...
### 36 · OPS-19 — Both repository-wide linters re-read every file on every run
...
### 37 · OPS-10 — Deciding whether a change is comments only costs a process per file
...
### 38 · OPS-2 — Nothing validates the contents of a restored `.env`
...
### 39 · OPS-3 — The crawler policy is split between robots.txt and Cloudflare, and neither knows about the other
...
### 40 · DOC-3 — A rule pattern in the documentation gate reaches less than the rule it enforces
...
### 41 · DOC-10 — A block already over a bound is excused by its opening line alone
