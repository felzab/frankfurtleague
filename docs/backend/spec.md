...
| #    | Item                                                            | State                                                                                                                                                                                                                           |
| ---- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| F4   | Team statistics write/read mismatch                             | **Open, unverified in a running system.** Ledger Finding F4                                                                                                                                                                     |
...
| BE-4 | No write path for `saisons` / `spieler` / `spieltage`           | Edited out of band; the frontend cache is cleared by a script. Tracked in `docs/audit/0-remediation-ledger.md`                                                                                                                  |
| BE-9 | The `is_placeholder` "TBD" team                                 | Should become a nullable opponent reference. Tracked in the remediation ledger                                                                                                                                                  |
