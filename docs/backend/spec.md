...
| #    | Item                                                            | State                                                                                                                                                                                                                                                 |
| ---- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| —    | The derived league table has no integration coverage            | `tests/api/test_teams_pipeline.py` asserts what the pipeline **says**; nothing executes it against MongoDB, because the suite has no database fixture. Tracked in [`../roadmap/open-items.md`](../roadmap/open-items.md)                              |
| —    | `saison_teams` still carries a `statistik` field                | Dead data since the derivation landed. Nothing reads or writes it; removing it is a one-off edit in Compass. Tracked in [`../roadmap/open-items.md`](../roadmap/open-items.md)                                                                        |
