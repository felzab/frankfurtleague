...
4. **Partition it into segments.** This table is the partition, and **every file that survives step 3
   ...
   | Public root documents       | `NOTICE` · `README.md` · `SECURITY.md`                                                                                                                                                                                                                                                                                                      |
   | Frontend source             | `fl_frontend/src/**`                                                                                                                                                                                                                                                                                                                        |
   | Backend source              | `fl_backend/app/**`                                                                                                                                                                                                                                                                                                                         |
   | Backend tests               | `fl_backend/tests/**`                                                                                                                                                                                                                                                                                                                       |
   | Gate scripts                | `scripts/**`                                                                                                                                                                                                                                                                                                                                |
   | Configuration and workflows | `.claude/hooks/**` · `.claude/settings.json` · `.github/**` · `.githooks/**` · `nginx/**` · `docker-compose*.yml` · `zizmor.yml` · `.editorconfig` · `.gitattributes` · `.gitignore` · `.prettierignore` · `.prettierrc.json` · `.vscode/**` · `fl_frontend/*` · `fl_frontend/eslint-plants/**` · `fl_frontend/patches/**` · `fl_backend/*` |
