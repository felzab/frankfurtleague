...
4. **Partition it into segments.** This table is the partition, and **every file that survives step 3
   ...
   | Configuration and workflows | `.claude/hooks/**` · `.claude/settings.json` · `.github/**` · `.githooks/**` · `nginx/**` · `docker-compose*.yml` · `zizmor.yml` · `.editorconfig` · `.gitattributes` · `.gitignore` · `.prettierignore` · `.prettierrc.json` · `.vscode/**` · `fl_frontend/*` · `fl_frontend/patches/**` · `fl_backend/*` |
