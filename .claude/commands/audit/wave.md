...
The session ends with the branch pushed, the draft pull request open and the conclusion of every
check it started named, `verify`'s run being one of several, per CLAUDE.md §2 and
`docs/_git/spec.md`.
