...
export default function SoccerError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="relative my-6 flex h-full w-[95%] flex-col items-center justify-center overflow-hidden rounded-2xl">
      ...
      <div className="relative z-2 flex w-[90%] flex-col items-center text-center">
        ...
        <div className="mb-8 space-y-2">
          ...
          <p className="text-fluid-sm px-2 font-normal whitespace-normal">
