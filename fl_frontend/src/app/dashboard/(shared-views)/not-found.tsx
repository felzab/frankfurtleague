  ...
  return (
    <div className="flex w-full flex-col items-center gap-y-4 py-16 text-center">
      ...
      <Link
        ...
        prefetch={false}
        className="text-fluid-sm bg-brand-solid text-brand-solid-foreground hover:scale-hover mt-2 rounded-xl px-6 py-3 font-bold transition-transform duration-200">
        Zur Team-Übersicht
      </Link>
    </div>
  );
