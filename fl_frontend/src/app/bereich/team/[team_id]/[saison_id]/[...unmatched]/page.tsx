...
// Reached only where every other route under a team's address has already refused it, so a mistyped
// one answers under the team shell (`docs/frontend/spec.md :: I232`).
export default function TeamUnmatchedRoute() {
