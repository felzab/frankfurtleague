...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      // Generated by `fl_frontend/scripts/generate-brand-assets.mjs`, never edited by hand. Both
      // purposes stay: without the `any` pair, platforms honouring it show the padded image.
