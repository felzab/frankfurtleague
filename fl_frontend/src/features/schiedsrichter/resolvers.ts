/**
 * SCHIEDSRICHTER · route-parameter resolution
 *
 * Bridges a dynamic route segment to a validated referee id. Out of `queries.ts` so a non-caching
 ...
 * - A bad referee id ends the render; unlike a season, there is no sensible fallback referee.
 */
...
/**
 * Parses a `[schiedsrichter_id]` route segment, or renders not-found.
 *
