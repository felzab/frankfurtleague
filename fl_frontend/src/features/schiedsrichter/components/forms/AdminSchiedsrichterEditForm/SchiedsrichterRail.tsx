...
export function SchiedsrichterRail({ banners }: { banners: readonly SchiedsrichterBanner[] }) {
  ...
  return (
    <div className="flex w-full flex-col gap-y-4">
      <RailSection
        ...
        info={
          <InfoHint label="Was die Hinweise bedeuten">
            Alle Warnungen zu diesem Schiedsrichter an einem Ort, auch die aus dem Formular.
          </InfoHint>
        }>
        {bannerCount === 0 ? (
