...
/**
 * The referee editor's summary rail — `SpielerRail` over a referee's draft, and identical in
 * structure for the same reason: a referee has no preview card and nothing waits on a referee field,
