    ...
    <div className="flex flex-wrap justify-center gap-2">
      {teamsRes.teams.map((teamData) => (
        <TeamPopoverMenu
          ...
          <span
            className={`text-fluid-xxs sm:text-fluid-xs text-field-fg hover:scale-hover inline-flex items-center rounded-xl border px-3.5 py-1.5 font-bold tracking-wide uppercase shadow-sm transition-transform duration-200 active:scale-95 ${
