...
const COLUMNS = "@min-[41rem]:grid-cols-2 @min-[62.25rem]:grid-cols-3";

/** A placeholder standing in for a card the grid shows only once it holds that many columns. */
export const FROM_TWO_COLUMNS = "hidden @min-[41rem]:block";
export const FROM_THREE_COLUMNS = "hidden @min-[62.25rem]:block";
