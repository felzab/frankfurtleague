  ...
  return (
    <div className="relative flex w-full flex-1 flex-col items-center">
      ...
      <div className="bg-background sticky top-0 z-20 flex w-full justify-center px-4 py-4 sm:px-8 lg:py-8">
        ...
        <div className="bg-surface border-border focus-within:border-brand max-w-toolbar flex h-12 w-full items-center gap-3 rounded-xl border px-4 shadow-sm transition-colors lg:h-15">
          <Magnifier
