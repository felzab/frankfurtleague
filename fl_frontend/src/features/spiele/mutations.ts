 ...
 * - `spiel_id` goes in the path and never in the body; this is where it is split off.
 * - The response parses with its OWN schema — `strip` mode would drop the advanced fixtures.
 *
 * See:
