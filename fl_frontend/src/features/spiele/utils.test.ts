...
describe("adminSpielEditHref", () => {
  it("addresses one fixture by its id", () => {
    assert.equal(adminSpielEditHref("6890a1b2c3d4e5f607182932", null), "/bereich/admin/spiele/6890a1b2c3d4e5f607182932");
  });
  ...
  it("carries the season the caller is showing", () => {
    assert.equal(adminSpielEditHref("6890a1b2c3d4e5f607182932", "9999"), "/bereich/admin/spiele/6890a1b2c3d4e5f607182932?saison_id=9999");
  });
});
