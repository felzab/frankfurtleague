 ...
 * a season, disqualification is the only way out (ADR-0033).
 */
...
// in every match the club plays in (ADR-0028 rule 3), and the count is how that silent half is seen.
...
// (ADR-0032). An id can, so reactivation names one and carries no body.
