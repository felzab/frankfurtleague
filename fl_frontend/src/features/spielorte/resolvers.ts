/**
 * SPIELORTE · route-parameter resolution
 *
 * Bridges a dynamic route segment to a validated venue id. Out of `queries.ts` so a non-caching
 ...
 * - A bad venue id ends the render; unlike a season, there is no sensible fallback venue.
 */
...
/**
 * Parses a `[spielort_id]` route segment, or renders not-found.
 *
