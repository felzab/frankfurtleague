...
/**
 * A field's label plus what the page knows about that field — `SpielerFieldLabel` over a venue's
 * draft, with the same single marker: a venue has no action-required categories, so the only thing
