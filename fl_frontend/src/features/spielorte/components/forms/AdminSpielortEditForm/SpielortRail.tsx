...
/**
 * The venue editor's summary rail — `SpielerRail` over a venue's draft, and identical in
 * structure for the same reason: a venue has no preview card and nothing waits on a venue field,
