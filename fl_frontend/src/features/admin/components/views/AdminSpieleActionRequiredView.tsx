          ...
          return (
            <Accordion.Item
              ...
              <Accordion.Heading level={2}>
                <Accordion.Trigger className="hover:bg-muted/80 focus-visible:border-brand flex w-full flex-row items-center justify-between rounded-2xl border border-transparent px-6 py-5 text-left transition-colors outline-none">
