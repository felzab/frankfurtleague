...
/**
 * Sited here for the tree walk above it, and reaching a surface this file's own name does not: the
 * sweep it fences is per-slice, so no slice's own file can fail for a tenth slice that arrives
 * carrying none.
 */
