 ...
 * site hand-rolling the border without `FIELD_HEIGHT_CLASSES` renders 36px beside a 40px trigger.
 * `border-control`, never `border-border`: a field's border alone identifies it.
 */
 ...
 * `FIELD_INPUT_CLASSES`'s `px-3` is in `utilities`, and layer order beats specificity, so its reservation loses.
 */
const INDICATOR_CLEARANCE_CLASSES = "pe-9";
 ...
 */
export const FIELD_TRIGGER_CLASSES = `${FIELD_INPUT_CLASSES} ${INDICATOR_CLEARANCE_CLASSES}`;
 ...
 */
export const TOGGLE_GROUP_ALIGN_CLASSES = "justify-center sm:justify-start";
 ...
 */
export const FIELD_ERROR_SWITCH_CLASSES = `${FIELD_ERROR_CLASSES} ps-1`;
 ...
 */
export const FIELD_MARKER_CLASSES = "inline-flex size-5 shrink-0 items-center justify-center rounded-full";
 ...
 */
export const DATE_PICKER_POPOVER_CLASSES = "rounded-xl p-0";
 ...
 */
export const DATE_PICKER_CALENDAR_CLASSES = "w-72 max-w-72 p-3 sm:w-84 sm:max-w-84 sm:p-4";
