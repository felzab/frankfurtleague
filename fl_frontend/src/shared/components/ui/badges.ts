 ...
 * shadow-sm`, an uppercase tracked "NICHT GESPEICHERT" chip, and the list chips — and the owner
 * called the drift out (fourth review of ADR-0050's page): the uppercase one was the least readable,
