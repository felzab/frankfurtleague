export function PageLoader() {
  return (
    <div
      // Without a live region a screen reader hears silence through the whole navigation.
      role="status"
      // `dvh`, not `vh`: on a phone `vh` is the chrome-HIDDEN height, so it overshoots the visible
      // area and the loading page scrolls. REASONED rather than measured — no device was available.
