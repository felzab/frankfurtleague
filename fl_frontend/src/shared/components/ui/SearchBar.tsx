...
export function SearchBar({
  ...
  return (
    <SearchField
      ...
      onChange={onChange}
      className={className}>
      <SearchField.Group className="bg-surface border-border focus-within:border-brand flex h-12 w-full items-center gap-3 rounded-xl border px-4 shadow-sm transition-colors lg:h-15">
