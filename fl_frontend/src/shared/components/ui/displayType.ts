 ...
 */
export const DISPLAY_HEADING_CLASSES = "font-heading font-normal tracking-display uppercase";
 ...
 * than a label.
 */
export const WORDMARK_CLASSES = "font-heading font-normal tracking-wide uppercase";
