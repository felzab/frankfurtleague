 ...
 */
const BRAND_GRADE_CLASSES = "text-brand hover:text-brand-solid dark:hover:text-brand-solid-accent";
 ...
 */
export const BRAND_INK_OUTSIDE_PROSE_CLASSES = `${BRAND_GRADE_CLASSES} transition-colors`;
