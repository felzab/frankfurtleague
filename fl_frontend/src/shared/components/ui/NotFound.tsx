  ...
  return (
    <StatusPanel
      ...
      watermark={
        ...
        <span
          className={`${DISPLAY_HEADING_CLASSES} text-foreground/20 sm:text-foreground/5 text-[7rem] leading-none motion-safe:animate-pulse sm:text-[15rem] md:text-[25rem] lg:text-[35rem]`}>
          404
        </span>
      }>
