      ...
      <div className="bg-surface/70 border-border relative z-10 flex w-full max-w-2xl flex-col items-center rounded-2xl border p-6 text-center shadow-2xl backdrop-blur-xl sm:rounded-3xl sm:p-12 md:p-16">
        ...
        <div className="mt-8 flex w-full flex-col-reverse justify-center gap-3 sm:mt-10 sm:flex-row sm:gap-4">
          ...
          <Link
            ...
            href="/"
            className="text-fluid-sm bg-brand-solid hover:bg-brand-solid/90 focus-visible:ring-brand focus-visible:ring-offset-background flex h-12 w-full items-center justify-center rounded-xl px-8 font-semibold text-white shadow-md transition outline-none hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-offset-2 sm:w-auto">
            Zur Startseite
          </Link>
        </div>
      </div>
