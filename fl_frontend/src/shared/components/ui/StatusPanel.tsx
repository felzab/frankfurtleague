...
const statusPanel = tv({
  slots: {
    ...
    panel: "relative z-10 flex w-full flex-col items-center rounded-2xl border border-border",
    badge: "mb-6 flex items-center gap-2 rounded-full border border-border bg-background px-3 py-1.5 shadow-sm",
    dot: "size-2 animate-pulse rounded-full",
    badgeText: "fluid-xxs font-extrabold tracking-widest text-foreground uppercase sm:fluid-xs",
    message: "leading-relaxed font-medium text-foreground-muted",
    digest: "mt-4 font-mono fluid-xxs tracking-wider text-foreground-muted",
  },
  variants: {
    variant: {
      page: {
        root: "overflow-hidden bg-background p-4 sm:p-6",
        panel: "max-w-2xl bg-surface/70 p-6 text-center shadow-2xl backdrop-blur-xl sm:rounded-3xl sm:p-12 md:p-16",
        badge: "sm:mb-8 sm:px-4",
        dot: "sm:h-2.5 sm:w-2.5",
        message: "mt-4 max-w-md fluid-base sm:mt-6",
      },
      inline: {
        root: "w-full p-6",
        panel: "max-w-lg bg-surface/50 p-8 shadow-sm",
        message: "mt-3 fluid-sm",
      },
    },
    /**
        ...
        <Heading
          className={
            variant === "page"
              ...
              : "fluid-lg font-extrabold tracking-tight text-foreground"
          }>
          {heading}
        </Heading>
