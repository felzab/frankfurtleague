"""
SPIELE · `build_spiele_pipeline` executed by a real MongoDB
...
and the 2025 fixture is the sharpest edge, because every wrong join key
...
class TestWhatTheMergeMustNotBreak:
    def test_an_unresolved_side_stays_null(self, league: SeededLeague) -> None:
        ...
        empty object here would render as a resolved side with a blank name.
        """
