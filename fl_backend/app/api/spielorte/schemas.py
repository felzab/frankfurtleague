...
class FLSpielort(BaseModel):
    ...
    default_mietpreis: int = Field(ge=0)
    # The day this venue was retired, or null while it is live (ADR-0032).
...
class FLSpielorteFilterParams(BaseModel):
    # A switch, not a value to match on: "inactive" is now a date, and a caller wanting the retired
