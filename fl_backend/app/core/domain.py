...
RULES: tuple[Rule, ...] = (
    ...
    Rule(
        ...
        operation="POST /saisons/{saison_id}/gruppen/swap",
        aggregate="Saison",
        summary="no group swap once a knockout fixture has been played, called off, given a goal count or a stored shoot-out",
        implemented_by="app.api.teams.services.find_gruppe_swap_refusal",
    ...
    Rule(
        ...
        operation="POST /saisons/{saison_id}/gruppen/swap",
        aggregate="Saison",
        summary="no group swap once either club's gruppenphase fixture has been played, called off, given a goal count or a stored shoot-out",
        implemented_by="app.api.teams.services.find_gruppe_swap_refusal",
